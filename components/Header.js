  ...
  return (
    <>
      ...
      <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600">
        <AiFillLinkedin className="hover:scale-110 duration-500 " />
        <AiFillGithub className="hover:scale-110 duration-500 " />
        <AiFillSkype className="hover:scale-110 duration-500 " />
        {/* <AiFillMail /> */}
      </div>
